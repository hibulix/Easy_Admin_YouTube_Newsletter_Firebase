...
class VideoPlayerController extends Controller
{
    ...
    public function renderpdfAction()
    {
        ...
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/vertin_go_website.jpg',30,null,150,83);
        ...
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/front.png',30,null,150,83);
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/front2.png',30,null,150,83);
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/file_carousel.gif',30,null,150,83);
        ...
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/front4.png',30,null,150,83);
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/front5.png',30,null,150,83);
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/front6.png',30,null,150,83);
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/front7.png',30,null,150,83);
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/front8.png',30,null,150,83);
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/front9.png',30,null,150,83);
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/front10.png',30,null,150,83);
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/front11.png',30,null,150,83);


        $pdf->Multicell(190, 5,'Back-End', '', 'C', false);

        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/admin.png',30,null,150,83);
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/admin2.png',30,null,150,83);
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/admin2-5.png',30,null,150,83);
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/admin2-6.png',30,null,150,83);
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/admin2-7.png',30,null,150,83);
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/admin3.png',30,null,150,83);
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/admin4.png',30,null,150,83);
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/admin5.png',30,null,150,83);
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/admin6.png',30,null,150,83);
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/admin7.png',30,null,150,83);
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/admin7-5.png',30,null,150,83);
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/admin8.png',30,null,150,83);
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/admin9.png',30,null,150,83);
        ...
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/admin10.png',30,null,150,83);
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/admin11.png',30,null,150,83);
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/admin12.png',30,null,150,83);
        ...
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/xampp.png',30,null,150,83);

        $pdf->Multicell(190, 5,'Cliquer sur admin pour acceder a l\'interface PhpMyAdmin:', '', 'C', false);

        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/phpmyadmin.png',30,null,150,83);
        ...
        $pdf->Multicell(190, 5,'php bin/console doctrine:database:create (Ou creer la base de donnee easy_admin directement dans PhpMyAdmin)', '', 'C', false);
        $pdf->Multicell(190, 5,'php bin/console doctrine:schema:create  (Creation des tables dans la base de donnee easy_admin)', '', 'C', false);
        $pdf->Multicell(190, 5,'php bin/console fos:user:create name test@example.com password  (Utilisation du bundle fosuserbundle)', '', 'C', false);
        $pdf->Multicell(190, 5,'php bin/console fos:user:promote user ROLE_ADMIN (Afin de vous logger sur l\'interface admin)', '', 'C', false);
        $pdf->Multicell(190, 5,'Page de login de l\'admin interface ==> http://localhost/easyadmin-master/web/app_dev.php/login', '', 'C', false);
        $pdf->Multicell(190, 5,'Page de front interface ==> http://localhost/easyadmin-master/web/app_dev.php/intro', '', 'C', false);
        ...
        $pdf->Multicell(190, 5,'Ajout d\'un fichier procfile avec le contenu suivant specifique pour les applications symfony dans le dossier web:', '', 'C', false);
        ...
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/postgre.png',30,null,150,83);

        $pdf->Multicell(190, 5,'Cliquer sur votre extension dans le sous menu du champs recherche:', '', 'C', false);

        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/postgre2.png',30,null,150,83);

        $pdf->Multicell(190, 5,'Cliquer ensuite sur settings:', '', 'C', false);

        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/postgre3.png',30,null,150,83);

        $pdf->Multicell(190, 5,'Cliquer sur view credentials:', '', 'C', false);

        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/postgre4.png',30,null,150,83);
        ...
        $pdf->Multicell(190, 5,'php bin/console doctrine:schema:create  (Creation des tables dans la base de donnee easy_admin)', '', 'C', false);  
        $pdf->Multicell(190, 5,'php bin/console fos:user:create name test@example.com password  (Utilisation du bundle fosuserbundle)', '', 'C', false);  
        $pdf->Multicell(190, 5,'php bin/console fos:user:promote user ROLE_ADMIN (Afin de vous connecter sur l\'interface admin)', '', 'C', false);  
        $pdf->Multicell(190, 5,'Page de login de l\'admin interface ==> https://platform-media.herokuapp.com/login', '', 'C', false);  
        $pdf->Multicell(190, 5,'Page de front interface ==> https://platform-media.herokuapp.com/intro', '', 'C', false);  
        ...
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/google%20cloud%20console.png',30,null,150,83);

        $pdf->Multicell(190, 5,'Cliquer sur creer des identifiants Id Client Auth', '', 'C', false);  

        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/google%20cloud%20console2.png',30,null,150,83);
        ...
        $pdf->Multicell(190, 5,'et ensuite accedez a la page: https://votre_heroku_app.herokuapp.com/listplaylist?pseudo=votre_nom_d_utilisateur', '', 'C', false);  
        ...
        $pdf->Multicell(190, 5,'etabli via YouTube Api V3: https://platform-media.herokuapp.com/listplaylist?pseudo=vertingo', '', 'C', false);  
        ...
        $pdf->Image('https://raw.githubusercontent.com/vertingo/Easy_Admin_YouTube_Newsletter_Firebase/master/web/assets/images/github/Disponible-sur-App-Store-Logo.jpg',30,null,150,83);
